...
const val TOKEN_GENERATION_AMOUNT = 1000
...
const val MAX_TOKEN_SEND_AMOUNT = (UDP_MAX_PACKET_SIZE / 8) - 2
...
val tokens = (List(TOKEN_GENERATION_AMOUNT) { Random.nextLong() }).toMutableSet()
